...
help:
	@echo "install"
	@echo "        Install tueopt and dependencies"
	@echo "uninstall"
	@echo "        Unstall tueopt"
	@echo "install-dev"
...
test:
	@pytest -vx --run-optional-tests=expensive --cov=tueopt test

test-light:
	@pytest -vx --cov=tueopt test
